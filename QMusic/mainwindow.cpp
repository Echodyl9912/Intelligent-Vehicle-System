    ...
    : QMainWindow(parent)
{
    ...
    connect(pushButton[7],&QPushButton::clicked,[=](){
        mypro->close();
        exit(1);//退出程序
    });
}
...
void MainWindow::musicLayout()
{
    ...
    pushButton[7]->setObjectName("EXIT");
    ...
    /* H3布局 */
    QSpacerItem *hSpacer5 = new QSpacerItem(30, 60,QSizePolicy::Minimum,QSizePolicy::Maximum);
    QSpacerItem *hSpacer6 = new QSpacerItem(30, 60,QSizePolicy::Maximum,QSizePolicy::Maximum);
    QSpacerItem *hSpacer7 = new QSpacerItem(30, 60,QSizePolicy::Maximum,QSizePolicy::Maximum);
    QSpacerItem *hSpacer8 = new QSpacerItem(30, 60, QSizePolicy::Maximum, QSizePolicy::Maximum);
    QSpacerItem *hSpacer9 = new QSpacerItem(30, 60,QSizePolicy::Minimum, QSizePolicy::Maximum);
    ...
    hBoxLayout[3]->addWidget(pushButton[7]);
