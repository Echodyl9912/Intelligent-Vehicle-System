    ...
    ui(new Ui::Widget)
{
    ...
    connect(ui->pushButton, SIGNAL(clicked()), this, SLOT(on_pushButton_clicked()));  /*停止检测*/
    connect(ui->btnClear, SIGNAL(clicked(bool)), this, SLOT(slotBtnClear()));  /*清楚曲线*/
    connect(ui->btnStartAndStop, SIGNAL(clicked(bool)), this, SLOT(slotBtnStartAndStop())); /*启动检测*/
...
void Widget::on_beepBt_clicked()
{
    /* 设置蜂鸣器的状态 */
      setBeepState();
}

void Widget::on_start2060Bt_clicked()
{
#if __arm__
...
void Widget::on_stop2060Bt_clicked()
{
#if __arm__
